...
local Utility = {}
local Objects = {}
function Meth:DraggingEnabled(frame, parent)
...
function Meth.CreateLib(MethName, themeList)
    ...
    Meth:DraggingEnabled(MainHeader, Main)
    ...
    function Meth:ChangeColor(prope,color)
